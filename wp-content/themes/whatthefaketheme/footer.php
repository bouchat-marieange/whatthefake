    ...
    <nav class="navbar fixed-bottom d-md-none" style="background-color: #330066;">
        <div class="container-fluid justify-content-around">
            <a href="#" class="nav-icon text-center">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo_icones/Gamepad.svg" alt="Challenge" height="24">
            </a>
            <a href="#" class="nav-icon text-center">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo_icones/Notes.svg" alt="Ressources" height="24">
            </a>
            <a href="#" class="nav-icon text-center">
                <img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo_icones/Bonus.svg" alt="Bonus" height="24">
            </a>
            <a href="#" class="nav-icon text-center">
